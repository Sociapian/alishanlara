...
<head>
  ...
  <title>Daily Long Grain Basmati Rice| Alishaan</title>
  <!-- Bootstrap CSS -->
   ...
   <section class="trending-banner">
    <div class="container-fluid">
        <div class="row justify-content-left">
            <img src={{ asset("imgs/daily-long-grain-banner.jpg") }} alt="suparba products">
        </div>
    </div>
   </section>
   ...
   <section class="product-details">
    <div class="container">
        <div class="row justify-content-center"> 
            <h2 class="mt-5 text-center text-white">Daily Long Grain Basmati Rice</h2>
            <hr>
            <p>Experience the perfect blend of quality and flavor with Alishaan Daily Long Grain Basmati Rice. Carefully sourced and aged to perfection, our premium basmati rice boasts extra-long grains, a delicate aroma, and a fluffy texture that elevates every meal. Whether you're preparing everyday dishes or special feasts, Alishaan ensures a rich taste and superior quality in every bite. Bring home the essence of tradition and purity with Alishaan Daily Long Grain Basmati Rice—where every grain tells a story of excellence.</p>
        </div>
        ...
        <div class="row justify-content-center mt-5 pb-5">
            ...
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">Extra-Long Grains</h3>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">Naturally Aromatic</h3>
                    </div>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">Fluffy Grains</h3>
                    </div>
                </div>
            </div>
