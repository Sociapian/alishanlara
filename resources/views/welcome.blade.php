...
<body>
  ...
  <!-- A royal Affair Section -->
   <section class="royal-affair">
    <div class="row">
        <div class="col-md-6 ra-left">
            <div data-aos="zoom-in-up" data-aos-duration="3000"><img src={{ asset("imgs/royal-affair.png")}} alt="Royal Affair Image"></div>
        ...
        <div class="col-md-6 ra-right" data-aos="fade-left" data-aos-duration="2000">
   ...
   <!-- about us section -->
    <section class="about-us">
        <div class="row">
            <div class="col-md-6 about-left" data-aos="fade-right">  
            ...
            <div class="col-md-6 about-right" data-aos="fade-left">
        ...
        <div class="row why-us">
            ...
            <hr class="gradient-line"> 
            <!-- Four Columns -->
            <div class="row why-us-section mb-5" data-aos="fade-up">
    ...
    <section class="being-alishan">
        <div class="container-fluid mb-5 ba-prod">
            <div class="row">
                <!-- Product Images -->
                <div class="col-lg-6 text-center m-0 rice" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
  ...
  <div class="container-fluid p-5">
   ...
   <div class="container-fluid mt-5 text-center map">
        <div data-aos="fade-up"><h3 class="mt-5">From Fields to Families</h3>
        <hr>
        <p class="text-uppercase">Our Presence</p></div>
   ...
   <!-- social and blog section -->
    <section class="socialblog">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 socialblog-left" data-aos="flip-left" data-aos-duration="3000">
