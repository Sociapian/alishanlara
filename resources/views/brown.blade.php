...
<head>
  ...
  <title>Brown Basmati Rice| Alishaan</title>
  <!-- Bootstrap CSS -->
   ...
   <section class="trending-banner">
    <div class="container-fluid">
        <div class="row justify-content-left">
            <img src={{ asset("imgs/brown-rice-banner.jpg") }} alt="suparba products">
        </div>
    </div>
   </section>
   ...
   <section class="product-details">
    <div class="container">
        <div class="row justify-content-center"> 
            <h2 class="mt-5 text-center text-white">Brown Basmati Rice</h2>
            <hr>
            <p>The perfect choice for health and taste filled with the exotic flavor of true Basmati Rice. This Basmati Rice helps in achieving your health goals without being heavy on the weight factor. Brown Basmati Rice is loved worldwide for its rich taste with ample health benefits and the flexibility of being cooked for many cuisines. The modern touch to the age-old authentic Basmati Rice is given when Brown Basmati Rice is cooked for Biryani and other heritage dishes across the world. A whole grain, rich in fiber, vitamins, minerals, and antioxidants, Alishaan Brown rice is Gluten and GMO-free.</p>
        </div>
        ...
        <div class="row justify-content-center mt-5 pb-5">
            ...
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    <img src={{ asset("imgs/smoothtexture.png") }} class="card-img-top" alt="Card Image 1">
                    <div class="card-body">
                        <h3 class="card-title">Technologically grown to be <br> cooked in under 15 minutes</h3>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    <img src={{ asset("imgs/authentic.png") }} class="card-img-top" alt="Card Image 2">
                    <div class="card-body">
                        <h3 class="card-title">Rich in fiber, vitamins, <br> minerals, and antioxidants</h3>
                    </div>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    <img src={{ asset("imgs/smoothtexture.png") }} class="card-img-top" alt="Card Image 3">
                    <div class="card-body">
                        <h3 class="card-title">Alishaan Brown rice is <br> Gluten and GMO-free</h3>
                    </div>
                </div>
            </div>
                ...
                <div class="text-center">
                    <div class="row">
                        ...
                        <div class="col-md-6 custom-box">
                            <p><strong>Pouch Pack</strong>: 1kg &nbsp;&nbsp; 5kg &nbsp;&nbsp; 20kg</p>
            ...
            <div class="carousel-inner">
                        ...
                        <div class="col-md-4">
                            <div class="product-card position-relative text-center">
                                ...
                                <div class="overlay d-flex justify-content-center align-items-center">
                                    <a href="/superba" class="text-decoration-underline text-white">View</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="product-card position-relative text-center">
                                <p class="product-title fw-bold mb-2">Aroma Basmati Rice</p>
                                <img class="img-fluid" src={{ asset("imgs/product02.png") }} alt="Superba Basmati Rice">
                                <div class="overlay d-flex justify-content-center align-items-center">
                                    <a href="/aroma-traditional" class="text-decoration-underline text-white">View</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="product-card position-relative text-center">
                                <p class="product-title fw-bold mb-2">Delight Indian Basmati Rice</p>
                                <img class="img-fluid" src={{ asset("imgs/product03.png") }} alt="Daily Basmati Rice">
                                <div class="overlay d-flex justify-content-center align-items-center">
                                    <a href="/delight" class="text-decoration-underline text-white">View</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="carousel-item">
                  <div class="row justify-content-center">
                      <div class="col-md-4">
                          <div class="product-card position-relative text-center">
                              <p class="product-title fw-bold mb-2">Daily Long Grain</p>
                              <img class="img-fluid" src={{ asset("imgs/product04.png") }} alt="XL Sella Basmati Rice">
                              <div class="overlay d-flex justify-content-center align-items-center">
                                  <a href="/daily-long-grain" class="text-decoration-underline text-white">View</a>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-4">
                          <div class="product-card position-relative text-center">
                              <p class="product-title fw-bold mb-2">XL Indian Basmati Rice</p>
                              <img class="img-fluid" src={{ asset("imgs/product05.png") }} alt="Superba Basmati Rice">
                              <div class="overlay d-flex justify-content-center align-items-center">
                                  <a href="/xlindian" class="text-decoration-underline text-white">View</a>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-4">
                          <div class="product-card position-relative text-center">
                              <p class="product-title fw-bold mb-2">Brown Basmati Rice</p>
                              <img class="img-fluid" src={{ asset("imgs/brown-rice.png") }} alt="Daily Basmati Rice">
                              <div class="overlay d-flex justify-content-center align-items-center">
                                  <a href="/brown-rice" class="text-decoration-underline text-white">View</a>
                              </div>
                          </div>
                      </div>
