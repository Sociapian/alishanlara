...
<head>
  ...
  <title>XL Indian Basmati Rice| Alishaan</title>
  <!-- Bootstrap CSS -->
   ...
   <section class="trending-banner">
    <div class="container-fluid">
        <div class="row justify-content-left">
            <img src={{ asset("imgs/xlindian-banner.jpg") }} alt="suparba products">
        </div>
    </div>
   </section>
   ...
   <section class="product-details">
    <div class="container">
        <div class="row justify-content-center"> 
            <h2 class="mt-5 text-center text-white">XL Sella Basmati Rice</h2>
            <hr>
            <p>Sella Basmati Rice is the parboiled Indian Basmati Rice that is loved by many across the world for its aromatic flavor and diabetic friendliness. The extra-long grains each have an enigmatic flavor of their own and when cooked in bulk, the alluring fragrance and flavor of the rice can add sparkle to any special occasion. The rice is loved for its bulk cooking as well as healthy properties that can be consumed by people with diabetes. It is loved in many countries for being the main source of their delicate cuisines including Iranian, Arabic, and Persian cuisines. The extra hard grains ensure that not a single grain breaks during cooking.</p>
        </div>
        ...
        <div class="row justify-content-center mt-5 pb-5">
            ...
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    <img src={{ asset("imgs/extra-hard.png") }} class="card-img-top" alt="Card Image 1">
                    <div class="card-body">
                        <h3 class="card-title">Extra Hard Grains suitable <br> for bulk cooking</h3>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    <img src={{ asset("imgs/arometic.png") }} class="card-img-top" alt="Card Image 2">
                    <div class="card-body">
                        <h3 class="card-title">Aromatic authentic <br> basmati rice flavor</h3>
                    </div>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    <img src={{ asset("imgs/parboiled.png") }} class="card-img-top" alt="Card Image 3">
                    <div class="card-body">
                        <h3 class="card-title">Parboiled Indian Basmati <br> Rice</h3>
                    </div>
                </div>
            </div>
                ...
                <div class="text-center">
                    <div class="row">
                        ...
                        <div class="col-md-6 custom-box">
                            ...
                            <p><strong>Non-Woven bag </strong>: 20kg &nbsp;&nbsp; 40lb</p>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                </div>
