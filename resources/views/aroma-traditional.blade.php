...
<head>
  ...
  <title>Aroma Traditional Basmati Rice| Alishaan</title>
  <!-- Bootstrap CSS -->
   ...
   <section class="trending-banner">
    <div class="container-fluid">
        <div class="row justify-content-left">
            <img src={{ asset("imgs/aroma-banner.jpg") }} alt="suparba products">
        </div>
    </div>
   </section>
   ...
   <section class="product-details">
    <div class="container">
        <div class="row justify-content-center"> 
            <h2 class="mt-5 text-center text-white">Aroma Traditional Basmati Rice</h2>
            <hr>
            <p>This rice is known for its aromatic flavor, aged for 18 months, and is given the delight of authentic basmati flavor. Its aroma is a delight for many cuisines across the world. The lovers of Biriyani, Pulao and many other authentic Basmati cuisines love this rice to be present in their cuisines because of its undeniable taste and aroma. This is also known as the Queen of Basmati Rice and adds the traditional touch to many dishes which leads you down the nostalgic lane of traditional cuisines. Used widely across the world for heritage dishes and traditional cuisines for its soothing old-school taste and aroma.</p>
        </div>
        ...
        <div class="row justify-content-center mt-5 pb-5">
            ...
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    <img src={{ asset("imgs/aged18.png") }} class="card-img-top" alt="Card Image 1">
                    <div class="card-body">
                        <h3 class="card-title">Aged 18 months</h3>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    <img src={{ asset("imgs/tasteandfeel.png") }} class="card-img-top" alt="Card Image 2">
                    <div class="card-body">
                        <h3 class="card-title">Taste and feel of <br> nostalgic aroma</h3>
                    </div>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    <img src={{ asset("imgs/theqweenof.png") }} class="card-img-top" alt="Card Image 3">
                    <div class="card-body">
                        <h3 class="card-title">The queen of <br> aromatic Basmati Rice</h3>
                    </div>
                </div>
            </div>
