...
<body>
  ...
  <section class="trending-banner">
   ...
   <section class="trending">
    <div class="container-fluid">
        <div data-aos="fade-up"><h2 class="pt-5 text-center">Trending</h2></div>
        <hr>
        <div class="row trending-row">
            <div class="col-md-6 trending-left" data-aos="fade-right">
            ...
            <div class="col-md-6 trending-right" data-aos="fade-up" data-aos-duration="3000">
        ...
        <div class="mt-5 mb-5 ms-5 text-center content-border trending-insta" data-aos="fade-up" data-aos-duration="3000">
