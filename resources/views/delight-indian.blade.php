...
<head>
  ...
  <title>Delight Indian Basmati Rice| Alishaan</title>
  <!-- Bootstrap CSS -->
   ...
   <section class="trending-banner">
    <div class="container-fluid">
        <div class="row justify-content-left">
            <img src={{ asset("imgs/delight-banner.jpg") }} alt="suparba products">
        </div>
    </div>
   </section>
        ...
        <div class="row justify-content-center mt-5 pb-5">
            ...
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">Smooth Texture and <br> aromatic taste</h3>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">Authentic Indian <br> Basmati Rice</h3>
                    </div>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="col-md-4 mt-5 d-flex justify-content-center">
                <div class="card text-center prod-card" style="width: 21rem;">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">Can be consumed as <br> everyday table rice</h3>
                    </div>
                </div>
            </div>
